package com.agjsj.mentality.ui.chat;

import android.content.Context;
import android.content.Intent;


import com.agjsj.mentality.network.UpdateCacheListener;
...
public class ChatMessageHandler extends BmobIMMessageHandler {
    ...
    private void excuteMessage(final MessageEvent event) {
        //检测用户信息是否需要更新
        UserNetwork.getInstance().updateUserInfo(event, new UpdateCacheListener() {
            @Override
