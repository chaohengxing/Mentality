...
public class ReplayDiscussJt {
    ...
    public String toString() {
        return ReplayDiscussJt.class.getSimpleName() + "{" +
                "id='" + id + '\'' +
                ", discussId='" + discussId + '\'' +
                ", replayUserType=" + replayUserType +
                ", replayUserId='" + replayUserId + '\'' +
                ", replayStudentInfo=" + replayStudentInfo +
                ", replayTeacherInfo=" + replayTeacherInfo +
                ", replayInfo='" + replayInfo + '\'' +
                ", replayTime='" + replayTime + '\'' +
                ", passiveUserType=" + passiveUserType +
                ", passiveUserId='" + passiveUserId + '\'' +
                ", passiveStudentInfo=" + passiveStudentInfo +
                ", passiveTeacherInfo=" + passiveTeacherInfo +
                '}';
    }
    ...
    /**
     * @param replayStudentInfo the replayStudentInfo to set
     */
    ...
    /**
     * @param replayTeacherInfo the replayTeacherInfo to set
     */
    ...
    /**
     * @param passiveStudentInfo the passiveStudentInfo to set
     */
    ...
    /**
     * @param passiveTeacherInfo the passiveTeacherInfo to set
     */
    ...
    /**
     * @param replayInfo the replayInfo to set
     */
    ...
    /**
     * @param replayTime the replayTime to set
     */
    ...
    /**
     * @param replayUserType the replayUserType to set
     */
    ...
    /**
     * @param replayUserId the replayUserId to set
     */
    ...
    /**
     * @param passiveUserType the passiveUserType to set
     */
    ...
    /**
     * @param passiveUserId the passiveUserId to set
     */
