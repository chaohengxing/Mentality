package com.agjsj.mentality.adapter.base;
...
public class BaseRecyclerHolder extends RecyclerView.ViewHolder {
    ...
    public BaseRecyclerHolder setImageView(String avatar, int defaultRes, int viewId) {
        ...
        if (avatar == null) {
            ...
            PicassoUtils.loadResourceImage(defaultRes, 100, 100, iv);
        } else {
            PicassoUtils.loadResizeImage(avatar, defaultRes, defaultRes, 100, 100, iv);
        }
        return this;
    }
}